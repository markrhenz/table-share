...
Bob,25,LA"
  ...
  <script>
    ...
    // Also process on blur if data exists
    pasteArea.addEventListener('blur', () => {
      const data = pasteArea.value.trim();
      if (data && !loading.classList.contains('active')) {
        processData();
      }
    });
...
// .wrangler/tmp/bundle-Ncx9rQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ncx9rQ/middleware-loader.entry.ts
